...
const PrivateMessageEditForm = ({ privateMessage, setReload, setEditMessageId }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        formData.append("owner", privateMessage.owner);
        ...
        formData.append("team", privateMessage.team);
...
export default PrivateMessageEditForm;